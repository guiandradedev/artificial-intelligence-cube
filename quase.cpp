...
void display()
{
    ...
    if(cubo.matrix[0][0][0].orientation == 0) {
        ...
        quadFill(preto, // laranja (traseira)
            -S, -S, OFFSET,
            -OFFSET, -S, OFFSET,
            -OFFSET, -S, S,
            -S, -S, S);
        quadFill(C[cubo.matrix[0][0][0].right], // azul (esquerda)
            -S, -OFFSET, OFFSET,
            -S, -S, OFFSET,
            -S, -S, S,
            -S, -OFFSET, S);
        quadFill(C[cubo.matrix[0][0][0].mid], // amarelo (face superior)
            -S, -S, S,
            -OFFSET, -S, S,
            -OFFSET, -OFFSET, S,
            -S, -OFFSET, S);
    } else if(cubo.matrix[0][0][0].orientation == 1) {
        quadFill(C[cubo.matrix[0][0][0].right], // laranja (traseira)
            -S, -S, OFFSET,
            -OFFSET, -S, OFFSET,
            -OFFSET, -S, S,
            -S, -S, S);
        quadFill(C[cubo.matrix[0][0][0].mid], // azul (esquerda)
            -S, -OFFSET, OFFSET,
            -S, -S, OFFSET,
            -S, -S, S,
            -S, -OFFSET, S);
        quadFill(C[cubo.matrix[0][0][0].left], // amarelo (face superior)
            -S, -S, S,
            -OFFSET, -S, S,
            -OFFSET, -OFFSET, S,
            -S, -OFFSET, S);
    } else {
        quadFill(C[cubo.matrix[0][0][0].mid], // laranja (traseira)
            -S, -S, OFFSET,
            -OFFSET, -S, OFFSET,
            -OFFSET, -S, S,
            -S, -S, S);
        quadFill(C[cubo.matrix[0][0][0].left], // azul (esquerda)
            -S, -OFFSET, OFFSET,
            -S, -S, OFFSET,
            -S, -S, S,
            -S, -OFFSET, S);
        quadFill(C[cubo.matrix[0][0][0].right], // amarelo (face superior)
            -S, -S, S,
            -OFFSET, -S, S,
            -OFFSET, -OFFSET, S,
            -S, -OFFSET, S);
    ...
    if(cubo.matrix[0][1][0].orientation == 0) {
        quadFill(C[cubo.matrix[0][1][0].left], // verde (direita)
            S, -S, OFFSET,
            S, -OFFSET, OFFSET,
            S, -OFFSET, S,
            S, -S, S);
        quadFill(C[cubo.matrix[0][1][0].right],
            OFFSET, -S, OFFSET,
            S, -S, OFFSET,
            S, -S, S,
            OFFSET, -S, S);
        quadFill(C[cubo.matrix[0][1][0].mid],
            OFFSET, -S, S,
            S, -S, S,
            S, -OFFSET, S,
            OFFSET, -OFFSET, S);
    } else if(cubo.matrix[0][1][0].orientation == 1) {
        quadFill(C[cubo.matrix[0][1][0].right], // verde (direita)
            S, -S, OFFSET,
            S, -OFFSET, OFFSET,
            S, -OFFSET, S,
            S, -S, S);
        quadFill(C[cubo.matrix[0][1][0].mid],
            ...
            S, -S, S,
            OFFSET, -S, S);
        quadFill(C[cubo.matrix[0][1][0].left],
            OFFSET, -S, S,
            S, -S, S,
            S, -OFFSET, S,
            OFFSET, -OFFSET, S);
    } else {
        quadFill(C[cubo.matrix[0][1][0].mid], // verde (direita)
            S, -S, OFFSET,
            S, -OFFSET, OFFSET,
            S, -OFFSET, S,
            S, -S, S);
    ...
    if(cubo.matrix[1][0][0].orientation == 0) {
        ...
        -S, OFFSET, S,
        -S, S, S);
        quadFill(C[cubo.matrix[1][0][0].right], // vermelho (frente)
            -S, S, OFFSET,
            -OFFSET, S, OFFSET,
            -OFFSET, S, S,
            -S, S, S);
        ...
        quadFill(C[cubo.matrix[1][0][0].right],
            ...
            -S, OFFSET, S,
            -S, S, S);
        quadFill(C[cubo.matrix[1][0][0].mid], // vermelho (frente)
            -S, S, OFFSET,
            -OFFSET, S, OFFSET,
            -OFFSET, S, S,
            -S, S, S);
        ...
        quadFill(C[cubo.matrix[1][0][0].mid],
            ...
            -S, OFFSET, S,
            -S, S, S);
        quadFill(C[cubo.matrix[1][0][0].left], // vermelho (frente)
            -S, S, OFFSET,
            -OFFSET, S, OFFSET,
            -OFFSET, S, S,
            -S, S, S);
