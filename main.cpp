...
int main() {
    ...
    while(!cube_queue.empty()) {
        ...
        i++;
        cube_queue.push(state.U_FW());
        cube_queue.push(state.U_BW());
        cube_queue.push(state.L_FW());
        cube_queue.push(state.L_BW());
        cube_queue.push(state.F_FW());
        cube_queue.push(state.F_BW());
