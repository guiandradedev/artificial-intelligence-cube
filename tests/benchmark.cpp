...
int main() {
    ...
    // Cabeçalho expandido com colunas de "N. Moves"
    cout << left 
         << setw(8) << "Index"
         << setw(10) << "Shuffles"
         << right 
    ...
    for(int shuffle = 1; shuffle < shuffle_max; shuffle++) {
        ...
        cout << setw(12) << (to_string(duration_bfs) + "ms") 
             << setw(12) << path.size()  // Número de movimentos BFS
             << setw(12) << num_tries;
        ...
        cout << setw(12) << (to_string(duration_dfs) + "ms") 
             << setw(12) << path.size()  // Número de movimentos DFS
             << setw(12) << num_tries;
        ...
        cout << setw(12) << (to_string(duration_astar) + "ms") 
             << setw(12) << path.size()  // Número de movimentos A*
